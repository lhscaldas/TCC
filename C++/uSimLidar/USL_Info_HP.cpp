...
void showHelpAndExit()
{
  blk("                                                          ");
  blu("==========================================================");
  blu("Usage: uSimLidar file.moos [OPTIONS]         ");
  blu("==========================================================");
  blk("                                                          ");
  showSynopsis();
  blk("                                                          ");
  ...
  blk("      Launch uSimLidar with the given        ");
  blk("      process name rather than uSimLidar.    ");
  mag("  --example, -e                                           ");
  ...
  mag("  --version,-v                                            ");
  blk("      Display release version of uSimLidar.  ");
  mag("  --verbose","=<setting>                                  ");
...
void showExampleConfigAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("uSimLidar Example MOOS Configuration               ");
  blu("=============================================================== ");
  blk("                                                                ");
...
void showInterfaceAndExit()
{
  ...
  blk("  USL_RANGE_REQUEST = name=archie                               ");
  blk("                                                                ");
  blk("PUBLICATIONS:                                                   ");
  blk("------------------------------------                            ");
  blk("  USL_RANGE_REPORT    = vname=archie,range=126.54,              ");
  blk("                        target=jackal,time=19656022406.44       ");
  blk("  USL_RANGE_REPORT_GT = vname=archie,range=126.54,              ");
  blk("                        target=jackal,time=19656022406.44       ");
